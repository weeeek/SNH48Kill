        ...
        card: {
            ...
            xietianzi: {
                ...
                enable: function (card, player, event) {
                    if (get.is.guozhanMode() && !player.isMajor()) return false;
            ...
            yuanjiao: {
                ...
                type: 'trick',
                enable: function (card, player) {
                    if (get.is.guozhanMode() && player.isUnseen()) return false;
                    return true;
                },
                filterTarget: function (card, player, target) {
                ...
                content: function () {
                    game.asyncDraw([target, player], [1, get.is.guozhanMode() ? 3 : 1]);
                },
                ai: {
                    basic: {
                        useful: 4,
            ...
            yiyi: {
                ...
                selectTarget: function () {
                    if (get.is.guozhanMode()) return -1;
                    return [1, 3];
                },
                content: function () {
                    target.draw(2);
