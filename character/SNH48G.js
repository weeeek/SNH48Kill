    ...
    return {
        ...
        skill: {
            ...
            complement: {
                ...
                trigger: { global: 'damageEnd' },
                filter: function (event, player) {
                    return event.player != player && event.player.hp > 0 && player.countCards('h', { name: 'sha' }) > 0 && event.source.group == player.group;
                },
                content: function (event) {
